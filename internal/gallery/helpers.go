...
func createMovieFromMovieInfo(movieInfo models.MovieInfo) models.Movie {
	return models.Movie{Id: movieInfo.Id, MovieId: movieInfo.MovieId, Name: movieInfo.Name,
		Genre: movieInfo.Genre, ReleaseYear: movieInfo.ReleaseYear, Director: movieInfo.Director,
...
func createMovieInfoFromMovie(movie models.Movie) models.MovieInfo {
	return models.MovieInfo{Id: movie.Id, MovieId: movie.MovieId, Name: movie.Name,
		Genre: movie.Genre, ReleaseYear: movie.ReleaseYear, Director: movie.Director,
